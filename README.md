...
* **YAPP 27기** – 기업형 IT 연합 동아리 서버 파트 (2025~)
* **초록해듀오** – 현직자 멘토링 기반 서버 개발 역량 강화 및 AI 활용 프로젝트 경험 (2025)
* **SOPT 34기** – 대학생 IT·스타트업 동아리 서버 파트 수료 (2024)
* **AWS Fundamentals** – AWS 클라우드 특화과정 수료 (2023)
* **CNU SW Academy** – 웹 백엔드 교육과정 수료 (2023)
* **Google Digital Marketing & E-Commerce** – 디지털 마케팅 특화과정 수료 (2023)
* **YLC 41기** – 시장경제 기반 학술 동아리 수료 (2022)
